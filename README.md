...
1) Отредактировал код:
          1. Убрал метод refresh_big_data()
          2. Перенес метод инициализации в самый нижний класс
          3. Рассписал параметры методов
          4. Описал все параметры в документации к классу edi_service_soap_ecod_pl
          5. Отловил еще 2 исключения, плохое соединение с интернетом, и без подключения к интернету.
 2) Узнал и на данный момент практикуюсь с дескрипторами и конструкторами.
